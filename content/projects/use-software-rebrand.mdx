...
<ProjectImage alt="USE Software 2026 rebrand hero mockup" src="/static/images/projects/use-software-rebrand-frame.png" />

<ProjectImage alt="Side-by-side desktop and mobile view of the final website showing responsive design" src="https://images.unsplash.com/photo-1559028012-481c04fa702d?w=1200&h=600&fit=crop" />
...
<ProjectImage alt="Competitive analysis dashboard showing common patterns across consultancy websites" src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&h=600&fit=crop" />
...
<ProjectImage alt="Notion database screenshot showing competitor research framework with ratings and notes" src="https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=1200&h=600&fit=crop" />
...
<ProjectImage alt="Split-screen comparison showing Figma design on left and final website implementation on right" src="https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?w=1200&h=600&fit=crop" />
...
<ProjectImage alt="Figma design system showing colour tokens, typography scale, and component variants" src="https://images.unsplash.com/photo-1561070791-2526d30994b5?w=1200&h=600&fit=crop" />
...
<ProjectImage alt="Screenshot of animated hero section mid-scroll with visible motion blur effects" src="https://images.unsplash.com/photo-1558655146-d09347e92766?w=1200&h=600&fit=crop" />
...
<ProjectImage alt="Mockup of Project and Provider brochures laid out side by side showing visual consistency" src="https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=1200&h=600&fit=crop" />
...
<ProjectImage alt="Interior spread of the Project brochure showing process timeline and key deliverables" src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1200&h=600&fit=crop" />
...
- **Performance**: 95%+ with fast LCP (Largest Contentful Paint)
- **Accessibility**: 95%+ ensuring assistive technology support
- **SEO**: 95%+ with structured data, semantic metadata, and local optimisation
- **Best Practices**: 95%+ modern web standards compliance

<ProjectImage alt="Lighthouse audit report showing all green scores above 95 for Performance, Accessibility, SEO, and Best Practices" src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=600&fit=crop" />
